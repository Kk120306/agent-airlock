...
Provider Discard events are persisted in an immutable authority-bound cleanup completion fact before local mutable state is removed so an interrupted cleanup can converge without inventing success.
...
| Local Quarantine is missing without an exact authority-bound provider Discard completion fact           | Fail recovery closed and do not claim remote cleanup.                                                                                                                                                                                                            |
